OVERVIEW
========
Minimal Data Representation (libmdr) ia a minimalistic serialization
library (plus a few extra tools, see below). It's C-friendly, has no
...
new message definitions. It attempts to minimize data copies when
unpacking, as much as possible.
